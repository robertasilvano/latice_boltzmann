...
class Lattice:
    def __init__(self):
        ...
        self.initial_vel = 1.9  # Velocidade inicial direita
    ...
    def seta_velocidades_iniciais(self):
        ...
        f_in[:, :, 3] = self.initial_vel  # seta o valor da velocidade inicial na célula 3, que representa uma velocidade no sentido positivo de x (direção 3)
