...
class SolidBody:
    @classmethod
    def monta_solid_body(cls, num_lattice_x, num_lattice_y, radius, solid_x_pos, solid_y_pos):
        '''
        ...
        solid_body = cls.check_collision_cylinder(num_lattice_x, num_lattice_y, radius, solid_x_pos, solid_y_pos, solid_body)  # monta o corpo sólido
        return solid_body
